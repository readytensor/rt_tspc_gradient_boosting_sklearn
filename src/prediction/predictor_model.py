...
class TimeStepClassifier:
    """Gradient Boosting TimeStepClassifier.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """
    MODEL_NAME = "Gradient_Boosting_TimeStepClassifier"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Gradient Boosting TimeStepClassifier.
    ...
    def build_model(self) -> GradientBoostingClassifier:
        """Build a new Gradient Boosting Classifier."""
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Gradient Boosting TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the Gradient Boosting TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded Gradient Boosting TimeStepClassifier.
        """
