...
class TSAnnotator:
    """Gradient Boosting Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TSAnnotator models.
    """
    MODEL_NAME = "Gradient_Boosting_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new Gradient Boosting TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Gradient Boosting TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the Gradient Boosting TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded Gradient Boosting TSAnnotator.
        """
